...
def read_batches(T, vocab_size):
    '''  Take as total text of characters as T  '''
    length = T.shape[0]; #129,665
    batch_chars = int(length / BATCH_SIZE); # 8,104

    for start in range(0, batch_chars - SEQ_LENGTH, SEQ_LENGTH): # (0, 8040, 64) -> (start, stop, increment)
